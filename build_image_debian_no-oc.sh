...
function setupImage {
    ...
    rm -f $MOUNTPOINT/etc/rc.local.final
    mv $MOUNTPOINT/boot/config.txt.no-oc $MOUNTPOINT/boot/config.txt
    mv $MOUNTPOINT/etc/rc.local.no-oc $MOUNTPOINT/etc/rc.local
    mv $MOUNTPOINT/etc/rc.local.final.no-oc $MOUNTPOINT/etc/rc.local.final
}
